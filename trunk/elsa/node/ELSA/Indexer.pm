...
our $Sphinx_index_sql_query_template = 'SELECT id, timestamp, host_id, host_id AS host, program_id, ' .
	'class_id, rule_id, msg, i0, i1, i2, i3, i4, i5, s0, s1, s2, s3, s4, s5, ' .
...
source perm_%1\$d : permanent {
        ...
        sql_query_pre = SET \@sql = CONCAT("SELECT id, timestamp, host_id, host_id AS host, program_id, class_id, rule_id, msg, i0, i1, i2, i3, i4, i5, s0, s1, s2, s3, s4, s5,i0 AS attr_i0, i1 AS attr_i1, i2 AS attr_i2, i3 AS attr_i3, i4 AS attr_i4, i5 AS attr_i5 FROM ", \@src_table, " WHERE id >= ", \@first_id, " AND id <= ", \@last_id)
